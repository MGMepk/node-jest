...
describe('SortedList', () => {
  ...
  describe('#even(i)', () => {
    ...
    test('should return an element on position', () => {
      sl.add(6);
      sl.add(10);
      sl.add(7);
      sl.add(20);
      expect(sl.even(3)).toBe(10);
    });

    test('should return a no es par exception if the element is not even',()=>{
      sl.add(6);
      sl.add(10);
      sl.add(7);
      sl.add(20);
      const error = new TypeError('no es par');
      expect(() => sl.even(2)).toThrow(error);
